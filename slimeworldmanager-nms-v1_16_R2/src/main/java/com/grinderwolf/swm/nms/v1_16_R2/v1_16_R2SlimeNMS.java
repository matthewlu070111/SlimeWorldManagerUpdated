...
import net.minecraft.server.v1_16_R2.GameRules.GameRuleKey;
import net.minecraft.server.v1_16_R2.GameRules.GameRuleValue;
...
public class v1_16_R2SlimeNMS implements SlimeNMS {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            ...
            try {
                if (UNIVERSE_DIR.exists()) {
                    java.nio.file.Files.walk(UNIVERSE_DIR.toPath())
    ...
    public v1_16_R2SlimeNMS(boolean isPaper) {
        isPaperMC = isPaper;
        try {
